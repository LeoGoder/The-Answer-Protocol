...
enum opt_code
{
  ...
  OPT_list = 1679,                           /* -list */
  OPT_mabi_ = 1680,                          /* -mabi= */
  OPT_mabicalls = 1681,                      /* -mabicalls */
  OPT_mabs_ = 1682,                          /* -mabs= */
  OPT_march_ = 1683,                         /* -march= */
  OPT_mbranch_cost_ = 1684,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1685,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1686,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1687,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1688,             /* -mcompact-branches= */
  OPT_mcrc = 1689,                           /* -mcrc */
  OPT_mdebug = 1690,                         /* -mdebug */
  OPT_mdebugd = 1691,                        /* -mdebugd */
  OPT_mdivide_breaks = 1692,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1693,                  /* -mdivide-traps */
  OPT_mdmx = 1694,                           /* -mdmx */
  OPT_mdouble_float = 1695,                  /* -mdouble-float */
  OPT_mdsp = 1696,                           /* -mdsp */
  OPT_mdspr2 = 1697,                         /* -mdspr2 */
  OPT_meb = 1698,                            /* -meb */
  OPT_mel = 1699,                            /* -mel */
  OPT_membedded_data = 1700,                 /* -membedded-data */
  OPT_meva = 1701,                           /* -meva */
  OPT_mexplicit_relocs = 1702,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1703,                  /* -mextern-sdata */
  OPT_mfix_24k = 1704,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1705,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1706,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1707,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1708,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1709,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1710,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1711,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1712,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1713,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1714,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1715,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1716,                 /* -mfp-exceptions */
  OPT_mfp32 = 1717,                          /* -mfp32 */
  OPT_mfp64 = 1718,                          /* -mfp64 */
  OPT_mfpxx = 1719,                          /* -mfpxx */
  OPT_mframe_header_opt = 1720,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1721, */              /* -mfused-madd */
  OPT_mginv = 1722,                          /* -mginv */
  OPT_mgp32 = 1723,                          /* -mgp32 */
  OPT_mgp64 = 1724,                          /* -mgp64 */
  OPT_mgpopt = 1725,                         /* -mgpopt */
  OPT_mhard_float = 1726,                    /* -mhard-float */
  OPT_mimadd = 1727,                         /* -mimadd */
  OPT_minterlink_compressed = 1728,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1729,              /* -minterlink-mips16 */
  OPT_mips = 1730,                           /* -mips */
  OPT_mips16 = 1731,                         /* -mips16 */
  OPT_mips3d = 1732,                         /* -mips3d */
  OPT_mllsc = 1733,                          /* -mllsc */
  OPT_mload_store_pairs = 1734,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1735,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1736,                    /* -mlong-calls */
  OPT_mlong32 = 1737,                        /* -mlong32 */
  OPT_mlong64 = 1738,                        /* -mlong64 */
  OPT_mloongson_ext = 1739,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 1740,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 1741,                  /* -mloongson-mmi */
  OPT_mlra = 1742,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1743,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1744,                           /* -mmad */
  OPT_mmadd4 = 1745,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1746,             /* -mmcount-ra-address */
  OPT_mmcu = 1747,                           /* -mmcu */
  OPT_mmemcpy = 1748,                        /* -mmemcpy */
  OPT_mmicromips = 1749,                     /* -mmicromips */
  OPT_mmsa = 1750,                           /* -mmsa */
  OPT_mmt = 1751,                            /* -mmt */
  OPT_mnan_ = 1752,                          /* -mnan= */
  OPT_mno_float = 1753,                      /* -mno-float */
  OPT_mno_flush_func = 1754,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1755,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1756,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1757,                     /* -mno-mips3d */
  OPT_modd_spreg = 1758,                     /* -modd-spreg */
  OPT_mpaired_single = 1759,                 /* -mpaired-single */
  OPT_mplt = 1760,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1761,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1762,               /* -mrelax-pic-calls */
  OPT_mshared = 1763,                        /* -mshared */
  OPT_msingle_float = 1764,                  /* -msingle-float */
  OPT_msmartmips = 1765,                     /* -msmartmips */
  OPT_msoft_float = 1766,                    /* -msoft-float */
  OPT_msplit_addresses = 1767,               /* -msplit-addresses */
  OPT_msym32 = 1768,                         /* -msym32 */
  OPT_msynci = 1769,                         /* -msynci */
  OPT_mtune_ = 1770,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1771,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1772,                          /* -mvirt */
  OPT_mvr4130_align = 1773,                  /* -mvr4130-align */
  OPT_mxgot = 1774,                          /* -mxgot */
  OPT_mxpa = 1775,                           /* -mxpa */
  OPT_n = 1776,                              /* -n */
  OPT_name_sort = 1777,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1778,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1779,              /* -no-integrated-cpp */
  OPT_no_pie = 1780,                         /* -no-pie */
  OPT_noasmopt = 1781,                       /* -noasmopt */
  OPT_nocpp = 1782,                          /* -nocpp */
  OPT_nodefaultlibs = 1783,                  /* -nodefaultlibs */
  OPT_nolibc = 1784,                         /* -nolibc */
  OPT_nophoboslib = 1785,                    /* -nophoboslib */
  OPT_nostartfiles = 1786,                   /* -nostartfiles */
  OPT_nostdinc = 1787,                       /* -nostdinc */
  OPT_nostdinc__ = 1788,                     /* -nostdinc++ */
  OPT_nostdlib = 1789,                       /* -nostdlib */
  OPT_o = 1790,                              /* -o */
  OPT_objects = 1791,                        /* -objects */
  OPT_p = 1792,                              /* -p */
  OPT_pass_exit_codes = 1793,                /* -pass-exit-codes */
  /* OPT_pedantic = 1794, */                 /* -pedantic */
  OPT_pedantic_errors = 1795,                /* -pedantic-errors */
  OPT_pg = 1796,                             /* -pg */
  OPT_pie = 1797,                            /* -pie */
  OPT_pipe = 1798,                           /* -pipe */
  OPT_print_file_name_ = 1799,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1800,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1801,          /* -print-multi-directory */
  OPT_print_multi_lib = 1802,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1803,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1804,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1805,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1806,               /* -print-prog-name= */
  OPT_print_search_dirs = 1807,              /* -print-search-dirs */
  OPT_print_sysroot = 1808,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1809,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1810,                    /* -print-value */
  OPT_quiet = 1811,                          /* -quiet */
  OPT_r = 1812,                              /* -r */
  OPT_remap = 1813,                          /* -remap */
  OPT_reverse_sort = 1814,                   /* -reverse-sort */
  OPT_s = 1815,                              /* -s */
  OPT_save_temps = 1816,                     /* -save-temps */
  OPT_save_temps_ = 1817,                    /* -save-temps= */
  OPT_shared = 1818,                         /* -shared */
  OPT_shared_libgcc = 1819,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1820,               /* -shared-libphobos */
  OPT_size_sort = 1821,                      /* -size-sort */
  /* OPT_specs = 1822, */                    /* -specs */
  OPT_specs_ = 1823,                         /* -specs= */
  OPT_static = 1824,                         /* -static */
  OPT_static_libasan = 1825,                 /* -static-libasan */
  OPT_static_libgcc = 1826,                  /* -static-libgcc */
  OPT_static_libgfortran = 1827,             /* -static-libgfortran */
  OPT_static_libgo = 1828,                   /* -static-libgo */
  OPT_static_libhwasan = 1829,               /* -static-libhwasan */
  ...
  OPT_std_c__23 = 1846,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1847, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1848, */                /* -std=c++2b */
  OPT_std_c__98 = 1849,                      /* -std=c++98 */
  OPT_std_c11 = 1850,                        /* -std=c11 */
  OPT_std_c17 = 1851,                        /* -std=c17 */
  /* OPT_std_c18 = 1852, */                  /* -std=c18 */
  /* OPT_std_c1x = 1853, */                  /* -std=c1x */
  OPT_std_c2x = 1854,                        /* -std=c2x */
  /* OPT_std_c89 = 1855, */                  /* -std=c89 */
  OPT_std_c90 = 1856,                        /* -std=c90 */
  OPT_std_c99 = 1857,                        /* -std=c99 */
  /* OPT_std_c9x = 1858, */                  /* -std=c9x */
  OPT_std_f2003 = 1859,                      /* -std=f2003 */
  OPT_std_f2008 = 1860,                      /* -std=f2008 */
  OPT_std_f2008ts = 1861,                    /* -std=f2008ts */
  OPT_std_f2018 = 1862,                      /* -std=f2018 */
  OPT_std_f95 = 1863,                        /* -std=f95 */
  OPT_std_gnu = 1864,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1865, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1866, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1867,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1868,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1869,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1870, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1871, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1872,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1873,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1874, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1875, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 1876,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1877,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1878,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1879, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1880, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1881,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1882, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1883,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1884,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1885, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1886, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1887,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1888, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1889, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1890, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1891, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1892, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1893,                     /* -std=legacy */
  OPT_stdlib_ = 1894,                        /* -stdlib= */
  OPT_symbol_ = 1895,                        /* -symbol= */
  OPT_symbolic = 1896,                       /* -symbolic */
  OPT_t = 1897,                              /* -t */
  OPT_time = 1898,                           /* -time */
  OPT_time_ = 1899,                          /* -time= */
  OPT_traditional = 1900,                    /* -traditional */
  OPT_traditional_cpp = 1901,                /* -traditional-cpp */
  OPT_tree_stats = 1902,                     /* -tree-stats */
  OPT_trigraphs = 1903,                      /* -trigraphs */
  OPT_type_stats = 1904,                     /* -type-stats */
  OPT_u = 1905,                              /* -u */
  OPT_undef = 1906,                          /* -undef */
  OPT_v = 1907,                              /* -v */
  OPT_version = 1908,                        /* -version */
  OPT_w = 1909,                              /* -w */
  OPT_wrapper = 1910,                        /* -wrapper */
  OPT_x = 1911,                              /* -x */
  OPT_z = 1912,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
